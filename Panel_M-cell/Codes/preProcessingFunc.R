# copied from svn://10.9.2.103/rblab/blmembers/albina/3i/Panel_BM-cel on Aug.1 2017
...
## preProcessingFunc <- function(inputPath, CSVfile, no_cores){
##            ....
## }
## inputPath is a list which contains paths of all the datasets sent at various times
## CSVfile contains the metadata spreadsheet in the form of a matrix
