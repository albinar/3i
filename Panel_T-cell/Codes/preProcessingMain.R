...
outputPath <- "/mnt/f/FCS data/IMPC/IMPC-Results/3i/Panel_T-cell/MLN/"

## Paths to the FCS files sent on Spleen Organ of August 2015, March 2016, and October 2016
inPath1 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2015-08-27/MLN T Labelled"
inPath2 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2016-03-08/MLN T 169+"
inPath3 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2016-10-11/MLN T Labelled"
inPath4 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2017-07-19/MLN 287 T"
...
# inCSVpath1 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_2015-08-27/attachments/download_phnMLNImmuno.csv"
# inCSVpath2 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_2016-03-08/attachments/MLN data RB.csv"
# inCSVpath3 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_2016-10-11/attachments/download_phnMLNImmuno.csv"
# 
...
# # Reading a single spreadsheet containing the metadata information for the complete 3i T-cell (MLN) dataset
