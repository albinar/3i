...
outputPath <- "/mnt/f/FCS data/IMPC/IMPC-Results/3i/Panel_BM-cell/"

## Paths to the FCS files sent on Spleen Organ of August 2015, March 2016, October 2016, July 2017, and some missing files sent on December 2016 + July 2017
inPath1 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2015-08-27/Bone Marrow Labelled"
inPath2 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2016-03-08/BM 169+"
inPath3 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2016-10-11/BM Labelled"
inPath4 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2016-12-12/Missing BM files"
inPath5 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2017-07-19/287 BM"
inPath6 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/KCL_WTSI_2017-07-19/Missing BM"
...
# inCSVpath1 <- "/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/attachments/20170725_phnBoneImmunophenotyping.csv"
# # Creating a list of all the CSV paths from where we will retrieve the metadata information from
# inputCSV <- list(inCSVpath1)

# # Reading a single spreadsheet containing the metadata information for the complete 3i Bone Marrow dataset
CSVfile <- read.csv("/mnt/f/FCS data/IMPC/IMPC_2016_Pilot_Data/KCL_WTSI_Sanger/attachments/20170725_phnBoneImmunophenotyping.csv")
